...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="dashboard.html"> <i class="menu-icon fa fa-dashboard"></i>Admin Details </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-th"></i><a href="package_up.html">Package Update & Delete</a></li>
                        </ul>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <div class="col-xl-6">
                <div class="card">
                    <div class="card-body" >
                      <center>Admin Detalis</center>
					  <hr></hr>
                        <!--/.row-->
                        <div class="chart-wrapper mt-4">
                           <table style="margin-left:130px; margin-top:50px; " border=2>
						   <tr style="color:#CD5C5C;"><td>id</td><td>Username</td><td>Password</td></tr>
""")
for i in x:
	print("""
	<tr style="color:#E9967A;"><td>%d</td><td>%s</td><td>%s</td></tr>
	"""%(i[0],i[1],i[2]))
print("""
</body>
</form>
